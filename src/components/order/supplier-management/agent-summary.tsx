    ...
    <Card className="bg-purple-50 border-purple-200">
      ...
      <CardContent className="space-y-4">
        ...
        <p className="text-sm text-gray-700">
          There is insufficient inventory to fulfill upcoming franchise orders for{" "}
          <strong>SLURPEE FROZEN DRINK 32OZ</strong> across your network. There are{" "}
        ...
        <p className="text-sm text-gray-700">
          ...
          remaining <span className="text-blue-600 underline cursor-pointer">3,512 pallets</span> from PepsiCo Inc,
          as well as send out instructions to produce{" "}
          <span className="text-blue-600 underline cursor-pointer">2,821</span> additional pallets of SLURPEE FROZEN DRINK
          32OZ.
        </p>
      </CardContent>
    </Card>
