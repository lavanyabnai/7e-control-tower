  ...
  return (
    <nav className="fixed top-0 left-0 right-0 py-4 px-6 flex items-center justify-between bg-blue-900">
      <div className="flex items-center gap-x-2">
       ...
       <Image className="block lg:hidden" src="/assets/7e-logo-color.svg" alt="logo" width={60} height={60} />
        <Image className="hidden lg:block" src="/assets/7e-logo-color.svg" alt="logo" width={40} height={40} />
